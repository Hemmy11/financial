...
import com.imooc.manager.ManagerApp;
...
@SpringBootTest(classes = ManagerApp.class,webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
   ...
   private static RestTemplate rest = new RestTemplate();
    ...
    public void zfindOne(){
        normals.forEach(product -> {
            ...
            System.out.println(baseUrl+"/products/"+product.getId());
