...
import com.imooc.api.domian.ParamInf;
import com.imooc.api.domian.ProductRpcReq;
...
public class ProductRpcImpl implements ProductRpc {
    ...
    public List<Product> query(ParamInf req) {
        ...
        Page<Product> result = productService.query(req.getIdList(),req.getMinRewardRate(),req.getMaxRewardRate(),req.getStatusList()
        ,pageable);
